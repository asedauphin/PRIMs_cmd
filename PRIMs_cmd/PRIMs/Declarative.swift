...
class Declarative: NSObject, NSCoding  {
    ...
    static let goalSelectionDefault = false
    ...
    // Indicates whether autonomous goal selection takes place
    var goalSelection = goalSelectionDefault
    ...
    */
    ...
    func setParametersToDefault() {
        ...
        goalSelection = Declarative.goalSelectionDefault
